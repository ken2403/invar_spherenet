# from https://github.com/Open-Catalyst-Project/ocp/blob/main/ocpmodels/modules/scaling/compat.py
...
ScaleDict = Union[dict[str, float], dict[str, Tensor]]
...
def load_scales_compat(module: nn.Module, scale_file: str | ScaleDict | None):
