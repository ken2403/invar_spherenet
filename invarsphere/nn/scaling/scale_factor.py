# from https://github.com/Open-Catalyst-Project/ocp/blob/main/ocpmodels/modules/scaling/scale_factor.py
...
def _check_consistency(old: Tensor, new: Tensor, key: str):
